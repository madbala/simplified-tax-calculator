...
const UserInputs = () => {
  ...
  const [eightyDSelf, setEightDSelf] = useState("");
  const [eightyDParent, setEightDParent] = useState("");
    ...
    <div className=" overflow-y-auto h-full w-1/4 h-full border-r border-gray-300 pr-10">
      <form onSubmit={onSubmit}>
        ...
        <div className="mt-5" data-tooltip="This is a message about">
          <label
            class="flex items-center space-x-2 block text-gray-700 font-bold mb-2"
            htmlFor="phone"
          >
